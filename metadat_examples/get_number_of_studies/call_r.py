...
if __name__ == "__main__":
    ...
    shell_command = 'Rscript /Users/htr365/Documents/Side_Projects/09_founding_lab/semester_project/meta-studies/metadat_examples/get_number_of_studies/get_number.R ' + "'"+ dataset+"'" +" '"+input+"'"
    #print(shell_command)
